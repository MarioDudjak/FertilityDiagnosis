            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li {{ (Request::is( '*statistics') ? 'class="active"' : '') }}>
                        <a href="{{ url ('stats') }}">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Statistics</a>
                        <!-- /.nav-second-level -->
                    </li>

                    <li {{ (Request::is( '*fertility_tool') ? 'class="active"' : '') }}>
                        <a href="{{ url ('fertility_tool') }}">
                            <i class="fa fa-edit fa-fw"></i>Fertility Diagnosis Tool</a>
                    </li>

                    <li {{ (Request::is( '*documentation') ? 'class="active"' : '') }}>
                        <a href="{{ url ('documentation') }}">
                            <i class="glyphicon glyphicon-star fa-fw"></i>API Documentation</a>
                    </li>
