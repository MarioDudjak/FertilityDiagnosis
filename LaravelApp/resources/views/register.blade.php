...
<div class="container">
    ...
    <div class="col-md-4 col-md-offset-4">
        <br />
        <br />
        <br /> @section ('login_panel_title','Please Sign Up') @section ('login_panel_body')
        <form action="{{route('signup')}}" role="form" method="post">
            <fieldset>
                <div class="form-group {{$errors->has('first_name') ? 'has-error':''}}">
                    <input class="form-control" placeholder="First name" name="first_name" value="{{Request::old('first_name')}}" type="text"
                        autofocus>
                </div>
        ...
        @endsection @include('widgets.panel', array('as'=>'login', 'header'=>true))
    </div>
</div>
</div>
@stop