                                ...
                                <table style="text-align: left" class="table">
                                    ...
                                    <tbody style="color:black">
                                        <tr class="active">
                                            ...
                                            @endif @if($result->season==-1)
                                            <td>
                                                Winter
                                            </td>
                                            @endif @if($result->season==0.33)
                                            <td>
                                                Summer
                                            </td>
                                            @endif @if($result->season==-0.33)
                                        ...
                                        <tr class="warning">
                                            ...
                                            @endif @if($result->alcohol==0.8)
                                            <td>
                                                Once a week
                                            </td>
                                            @endif @if($result->alcohol==0.6)
                                            <td>
                                                Several times a week
                                            </td>
                                            @endif @if($result->alcohol==0.4)
                                            <td>
                                                Every day
                                            </td>
                                            @endif @if($result->alcohol==0.2)
                                            <td>
                                                Several times a day
                                            </td>
                                            @endif
