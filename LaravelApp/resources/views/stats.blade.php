        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 msf-form">
                    ...
                    <fieldset>
                        <h4>Choose the variable to which you want to examine the output of the diagnosis
                            <span class="step"></span>
                        </h4>
                        <p>This statistics show percentage of normal outputs by some variable which you can choose. Data presented
                            in form of a bar chart is retrieved from our large database and it shows how some attribute influences
                            on output of your diagnosis. Percentage is calculated according to results from all our users.
                            If some percentage is 100% it does not necessarily means that it is certain that your diagnosis
                            will be normal too. That number only shows what percentage of our users had normal diagnosis
                            while having that attribute value. Also, if the percentage is 0%, it does not mean that there
                            is no chance that your diagnosis will be normal if corresponding attribute value is same for
                            you. It can mean that zero or little number of users had that attribute value.
                        </p>
                        </br>
