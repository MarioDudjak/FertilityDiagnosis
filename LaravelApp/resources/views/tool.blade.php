		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12 description-text">
					<p>
						100 volunteers provided a semen sample which was analyzed according to the WHO 2010 criteria. Sperm concentration are related
						to socio-demographic data, environmental factors, health status, and life habits. Based on that samples we created
						a tool which can predict diagnosis of your test.
					</p>
					<div class="divider-1">Before infertility testing, your doctor or clinic works to understand your sexual habits and may make recommendations
						based on these. In some infertile couples, no specific cause is found (unexplained infertility). Infertility evaluation
						can be expensive, and sometimes involves uncomfortable procedures. Many medical plans may not reimburse the cost of
						fertility treatment. Finally, there's no guarantee — even after all the testing and counseling — that you are fertile.</div>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-sm-12 msf-form">
					...
					<form role="form" action="{{route('result')}}" method="post" class="form-inline">
						<fieldset>
							<h4>Season in which the analysis was performed
								<span class="step">(Step 1 / 9)</span>
							</h4>
							...
							<br>
							<button type="button" class="btn btn-next">Next
						...
						<fieldset>
							<h4>Age at the time of analysis
								<span class="step">(Step 2 / 9)</span>
							</h4>
							<div class="form-group {{$errors->has('age') ? 'has-error':''}}">
								<label for="age">Age (From 18 to 36):</label>
								<br>
						...
						<fieldset>
							<h4>Childish diseases
								<span class="step">(Step 3 / 9)</span>
							</h4>
						...
						<fieldset>
							<h4>Accident or serious trauma
								<span class="step">(Step 4 / 9)</span>
							</h4>
						...
						<fieldset>
							<h4>High fevers in the last year
								<span class="step">(Step 6 / 9)</span>
							</h4>
						...
						<fieldset>
							<h4>Frequency of alcohol consumption
								<span class="step">(Step 7 / 9)</span>
							</h4>
						...
						<fieldset>
							<h4>Number of hours spent sitting per day
								<span class="step">(Step 9 / 9)</span>
							</h4>
							<div class="form-group {{$errors->has('sitting') ? 'has-error':''}}">
								<label for="sitting">Number of hours spent sitting per day (From 0 to 16):</label>
								<br>
