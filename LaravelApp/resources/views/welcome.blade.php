...
<body id="page-top" class="index">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Contact me regarding this project and if you need another web page!</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{route('contact')}}" role="form" method="post" name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            <div class="col-md-6">
    ...
    <footer>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; Mario Dudjak 2017</span>
                </div>
                <div class="col-md-4">
